...
class Des
{
     ...
     * @return string
     */
    private static function _des(string $key, $message, $encrypt, $mode = 0, $iv = null): string
    {
     ...
     * @return array
     */
    private static function _createKeys(string $key): array
    {
        //declaring this locally speeds things up a bit
        ...
        $keys = []; // size = 32 * iterations but you don't specify this in php
